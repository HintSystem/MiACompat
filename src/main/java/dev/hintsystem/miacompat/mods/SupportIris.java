// Credit to the creators of the Skyblocker mod for Iris compatibility
...
public class SupportIris {
    ...
    private static void assignPipeline(RenderPipeline pipeline, String irisProgramName) {
        try {
            ...
            MiACompat.LOGGER.error("[MiACompat Iris Compatibility] Failed to assign pipeline {} to {}.", pipeline.getLocation(), irisProgramName, e);
        }
    }
